...
// Set() é para dar tracking a elementos nao repetidos, ou seja, forma mais optimizada para dar uma volta a uma lista sem repetições
const quoteTag = document.getElementById("quote")

  
function quoteGenerator() {
    //quoteTag.innerHTML = quotes[1]    
    //quoteTag.innerHTML = quotes[0]
